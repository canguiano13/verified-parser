...
//ensures exists j : nat:: 0< j < |tok[i].token_value| ==> tok[i].token_value==str[j..j+|tok[i].token_value|]
{
...

{
    ...
    invariant Flatten(tok)==str[0..i]
    {
        ...
        assume{:axiom} validType(tok[|tok|-1]) || tok[|tok|-1].token_type==TEMPSTRING;
